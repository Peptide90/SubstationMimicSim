...
export const CHALLENGE_SCENARIOS: ChallengeScenario[] = [
  ...
  },
  {
    ...
    initialGraph: {
      ...
      player: {
        nodes: [
          makeNode("junction", "J-2L", 200, 140, {}),
          makeNode("junction", "J-2R", 640, 140, {}),
          makeNode("ds", "DS-2", 260, 140, { state: "closed" }),
          makeNode("cb", "CB-2", 420, 140, { state: "closed" }),
          makeNode("ds", "DS-2A", 560, 140, { state: "closed" }),
          makeNode("ds", "DS-2B", 420, 300, { state: "closed" }),
          makeNode("ds", "DS-2C", 540, 300, { state: "closed" }),
        ],
        edges: [
          ...
          makeBusbarEdge("J-2L", "DS-2B", "B", "L", "bb-t2-7", "bb-t2-7"),
          makeBusbarEdge("DS-2B", "DS-2C", "R", "L", "bb-t2-8", "bb-t2-8"),
          makeBusbarEdge("DS-2C", "J-2R", "R", "B", "bb-t2-9", "bb-t2-9"),
        ],
      },
    },
    buildRules: {
      allowedPalette: [],
      lockedNodes: ["SRC-2", "LOAD-2", "DS-2", "CB-2", "DS-2A", "DS-2B", "DS-2C", "J-2L", "J-2R"],
      lockedEdges: ["bb-t2-1", "bb-t2-2", "bb-t2-3", "bb-t2-4", "bb-t2-5", "bb-t2-6", "bb-t2-7", "bb-t2-8", "bb-t2-9"],
    },
    objectives: [
      {
        id: "obj-warning",
